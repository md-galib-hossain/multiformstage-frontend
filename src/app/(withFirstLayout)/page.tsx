...
const Homepage = () => {
  ...
  return (
    <div className="bg-slate-200 min-h-screen p-4 flex justify-center items-center">
      ...
      {isClient && (
        <div className="mx-auto w-full max-w-4xl p-4 sm:p-4 md:p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 grid grid-cols-12 gap-4 min-h-[690px]">
          {/* Steps component */}
